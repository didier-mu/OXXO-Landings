...
$(document).ready(function(){function e(){var e=document.createElement("input"),o=window.location.href;document.body.appendChild(e),e.value=o,e.select(),document.execCommand("copy"),document.body.removeChild(e)}function o(){$(window).width()<996?$(".carruselFooter").owlCarousel({autoplay:!0,dots:!1,nav:!1,items:3,autoWidth:!1,loop:!0,autoplayTimeout:3e3}):$(".carruselFooter").owlCarousel("destroy")}$(".header--navegacion .btn").on("click",function(){$(".header").toggleClass("headerOn"),$(this).toggleClass("nav-on")}),$("#header--logo").on("click",function(){history.replaceState(null,null," "),$("html, body").animate({scrollTop:0},1500),$(".header--navegacion .btn").removeClass("nav-on"),$(".navbar-collapse").removeClass("show"),$(".header").removeClass("headerOn")}),$("#navbarNav li").on("click",function(){var e=$(this).attr("id").replace("li-","");$("."+e).offset().top;return $("html, body").animate({scrollTop:$("."+e).offset().top-90},1500),$(".header--navegacion .btn").removeClass("nav-on"),$(".navbar-collapse").removeClass("show"),$("#navbarNav li").removeClass("activo"),$(this).addClass("activo"),$(".header").removeClass("headerOn"),!1});var t=$("section");$(document).scroll(function(){t.each(function(){var e=$(this).offset().top-150,o=$(window).scrollTop(),t=$(this).attr("class").replace("s","li-s");o>e&&($("#navbarNav li").removeClass("activo"),$("#"+t).addClass("activo"))})}),function(){$(".carousel-indicators li").on("click",function(){$(".carousel-indicators li").removeClass("active"),$(this).addClass("active")})}(),function(){function e(){$(".sectionFade").each(function(){var e=$(this).offset().top-450;$(window).scrollTop()>e?$(this).find($(".objetFade")).addClass("transition1"):$(this).find($(".objetFade")).removeClass("transition1")})}e(),$(document).scroll(function(){e()})}(),$(".checkboxes").on("click",function(){$(this).find("input").attr("checked")?$(this).find("input").removeAttr("checked"):$(this).find("input").attr("checked","checked")}),$("#selectEdo").on("change",function(){$("#linkBoton").attr({href:$(this).val(),target:"_blank"}),$("#errorCombo").remove()}),$("#boton-buscar").on("click",function(){if(null!=$("#selectEdo").val()){if($("#errorCombo").remove(),2==$(".checkbox[checked]").length){$("#errorLegales").remove();var e="Especialista-"+jQuery("#selectEdo option:selected").text();return dataLayer.push({event:e}),!0}return $("#errorLegales").remove(),$("#checkTerminos").after("<span class='error-input' id='errorLegales'>Debes aceptar el Aviso de Privacidad y Términos y Condiciones"),!1}$("#errorCombo").remove(),$(".combo").after("<span class='error-input' id='errorCombo'>Elige un estado")}),function(){var e=document.querySelector("#selectEdo"),o=function(o){var t=e.options[e.selectedIndex].id;window.dataLayer.push({event:t})};e.addEventListener("change",o,!0)}(),$(".home--dia--redes--share").on("click",function(){e(),$(this).siblings("span").remove(),$(this).append("<span class='error-input'>¡Listo para compartir!"),setTimeout(function(){$(".error-input").remove()},3e3)}),$(window).resize(function(){o()}),setTimeout(function(){document.getElementById("videoThumbnail").innerHTML='<iframe id="iframeVideo" src="https://www.youtube.com/embed/5ygOC02y7BE" width="560" height="315" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen>'},2e3)});
